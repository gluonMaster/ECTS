    ...
    <div align="center">
        <table>
            ...
            $q = "SELECT Name_of_disc, Opp, Code, Credits, Program
                  	...
                  	WHERE Opp='Operation and maintenance of ship electrical equipment and means of automation' AND Verified='1'
                  	UNION 
            ...
            foreach ($result as $result){
                echo '	<tr>
							<td><b>' .$result[2]. '</b></td>
							<td><a href="Details_en.php?id=' .$result[2]. '&aus=7">' .$result[0]. '</a></td>
							<!--<td>' .$result[0]. '</td>-->
