    ...
    <div align="center">
        <table>
            ...
            $q = "SELECT Name_of_disc, Opp, Code, Credits, Program
                  	...
                  	WHERE Opp='Management of organisations and administration of Sea and River Transport' AND Verified='1'
                  	UNION 
            ...
            foreach ($result as $result){
                echo '	<tr>
							<td><b>' .$result[2]. '</b></td>
							<td><a href="Details_en.php?id=' .$result[2]. '&aus=9">' .$result[0]. '</a></td>
							<!--<td>' .$result[0]. '</td>-->
							<td>' .$result[1]. '</td>
							<td>' .$result[4]. '</td>
							<td>' .$result[3]. '</td>
