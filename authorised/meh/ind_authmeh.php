...
<div class="wrapper">
    ...
    <h2 align="center">На цієї сторінці авторизований користувач може оглядати, редагувати чи добавляти інформацію про освітні компоненти які викладаються <span class="colortext">ННІ інженерії</span></h2>

    <br>
    <br>
    <form name="search" method="post" action="searchmeh.php">
    ...
    <div align="center">
        <table>
            ...
            ?>
                <tr>
							<td><b> <?= $result[1] ?></b></td>
                            <td><a href="../../Details.php?id=<?= $result[1] ?>&aus=2"><?= $result[0] ?> </a></td>
                            <td><?= $result[4] ?> </td>
							<td><?= $result[2] ?> </td>
							<td><?= $result[3] ?> </td>
							<td><a href="updatemeh.php?code=<?= $result[1] ?>">Редагувати</a></td>
							<td><a style="color: crimson;" href="delmeh_ver.php?code=<?= $result[1] ?>">Видалити</a></td>
                    <?php
                    if($result[5]==1){
        ...
        <div align="center">
            <a href="createmeh.php" class="btn2 third2">Додати<br>нову дисципліну</a>
        </div>
