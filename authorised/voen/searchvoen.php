...
<div class="wrapper">
    ...
    <center>
        <table>
            ...
            {
                $link = mysqli_connect('localhost', 'operatorvoen', 'voeN_operator', 'ekts1');
                ...
                if (!empty($query))
                {
				  ...
				  OR Name_of_disc LIKE '%$query%'";
					...
					<tr>
						...
						<td><a href="../../Details.php?id=' .$result[2]. '&aus=17">Детальніше</a></td>
					</tr>';
    ...
    <div align="center">
        <a href="ind_authvoen.php" class="btn2 third2">Повернутися<br>до форми пошуку</a>
    </div>
