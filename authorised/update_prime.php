...
$q="SELECT * FROM `disciplines` WHERE `Code`='$code'
    UNION 
    SELECT * FROM `disciplines_avt` WHERE `Code`='$code'
    UNION 
    SELECT * FROM `disciplines_azov` WHERE `Code`='$code'
    UNION 
    SELECT * FROM `disciplines_colmar` WHERE `Code`='$code'
    UNION 
    SELECT * FROM `disciplines_coltr` WHERE `Code`='$code'
    UNION 
    SELECT * FROM `disciplines_dun` WHERE `Code`='$code'
    UNION 
    SELECT * FROM `disciplines_mdzh` WHERE `Code`='$code'
    UNION 
    SELECT * FROM `disciplines_meh` WHERE `Code`='$code'
    UNION 
    SELECT * FROM `disciplines_neop` WHERE `Code`='$code'
    UNION 
    SELECT * FROM `disciplines_voen` WHERE `Code`='$code'";

$q_eng="SELECT * FROM `disciplines_eng` WHERE `Code`='$code'
        UNION 
        SELECT * FROM `disciplines_avt_eng` WHERE `Code`='$code'
        UNION 
        SELECT * FROM `disciplines_azov_eng` WHERE `Code`='$code'
        UNION 
        SELECT * FROM `disciplines_colmar_eng` WHERE `Code`='$code'
        UNION 
        SELECT * FROM `disciplines_coltr_eng` WHERE `Code`='$code'
        UNION 
        SELECT * FROM `disciplines_dun_eng` WHERE `Code`='$code'
        UNION 
        SELECT * FROM `disciplines_mdzh_eng` WHERE `Code`='$code'
        UNION 
        SELECT * FROM `disciplines_meh_eng` WHERE `Code`='$code'
        UNION 
        SELECT * FROM `disciplines_neop_eng` WHERE `Code`='$code'
        UNION 
        SELECT * FROM `disciplines_voen_eng` WHERE `Code`='$code'";
...
<div class="wrapper">
    ...
    <main>
        <form action="../authorised/update_prime_add.php" method="post">
