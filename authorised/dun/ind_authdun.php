...
<div class="wrapper">
    ...
    <h2 align="center">На цієї сторінці авторизований користувач може оглядати, редагувати чи добавляти інформацію про освітні компоненти які викладаються <span class="colortext">Дунайським інститутом НУ "ОМА"</span></h2>

    <br>
    <br>
    <form name="search" method="post" action="searchdun.php">
    ...
    <div align="center">
        <table>
            ...
            ?>
                <tr>
							<td><b> <?= $result[1] ?></b></td>
							<td><a href="../../Details.php?id=<?= $result[1] ?>&aus=14"><?= $result[0] ?> </a></td>
                            <td><?= $result[4] ?> </td>
							<td><?= $result[2] ?> </td>
							<td><?= $result[3] ?> </td>
							<td><a href="updatedun.php?code=<?= $result[1] ?>">Редагувати</a></td>
							<td><a style="color: crimson;" href="deldun_ver.php?code=<?= $result[1] ?>">Видалити</a></td>
                    <?php
        ...
        <div align="center">
            <a href="createdun.php" class="btn2 third2">Додати<br>нову дисципліну</a>
        </div>
