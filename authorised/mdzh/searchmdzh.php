...
<div class="wrapper">
    ...
    <center>
        <table>
            ...
            {
                $link = mysqli_connect('localhost', 'operatormdzh', 'mdZH_operator', 'ekts1');
                ...
                if (!empty($query))
                {
				  ...
				  OR Name_of_disc LIKE '%$query%'";
					...
					<tr>
						...
						<td><a href="../../Details.php?id=' .$result[2]. '&aus=15">Детальніше</a></td>
					</tr>';
    ...
    <div align="center">
        <a href="ind_authmdzh.php" class="btn2 third2">Повернутися<br>до форми пошуку</a>
    </div>
