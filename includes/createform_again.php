<div class="container">
    ...
    <div class="tooltip">
        ...
        <input class="field" type="text" name="Code" id="f-code" value="<?= $_COOKIE["Code"] ?>">
    </div>
    ...
    <div>
        ...
        <input class="field" type="text" name="Name" id="f-name" value="<?= $_COOKIE["Name"] ?>">
    </div>
    ...
    <div>
        ...
        <input class="field" type="text" name="bakmag" id="f-bakmag" value="<?= $_COOKIE["bakmag"] ?>">
    ...
    <div>
        ...
        <input class="field" type="number" name="Credits" id="f-credits" value="<?= $_COOKIE["Credits"] ?>">
    </div>
    ...
    <div>
        ...
        <input class="field" type="text" name="Lang" id="f-mova" value="<?= $_COOKIE["Lang"] ?>">
    </div>
    ...
    <div>
        ...
        <?php
            if($_COOKIE["Select"]=='Навігація і управління морськими суднами'){
                echo '
            ...
            elseif ($_COOKIE["Select"]=='Управління судновими технічними системами і комплексами'){
                echo '
                    <select class="field" name="Select" size="6" multiple id="f-sel">
                        <option value="Навігація і управління морськими суднами">Навігація і управління морськими суднами</option>
                        <option selected value="Управління судновими технічними системами і комплексами">Управління судновими технічними системами і комплексами</option>
                        <option value="Експлуатація суднового електрообладнання і засобів автоматики">Експлуатація суднового електрообладнання і засобів автоматики</option>
                        <option value="Автоматизоване управління судновими енергетичними установками">Автоматизоване управління судновими енергетичними установками</option>
                        <option value="Менеджмент в галузі морського та річкового транспорту">Менеджмент в галузі морського та річкового транспорту</option>
                        <option value="Право">Право</option>
            ...
            elseif ($_COOKIE["Select"]=='Експлуатація суднового електрообладнання і засобів автоматики'){
                echo '
                    <select class="field" name="Select" size="6" multiple id="f-sel">
                        <option value="Навігація і управління морськими суднами">Навігація і управління морськими суднами</option>
                        <option value="Управління судновими технічними системами і комплексами">Управління судновими технічними системами і комплексами</option>
                        <option selected value="Експлуатація суднового електрообладнання і засобів автоматики">Експлуатація суднового електрообладнання і засобів автоматики</option>
                        <option value="Автоматизоване управління судновими енергетичними установками">Автоматизоване управління судновими енергетичними установками</option>
                        <option value="Менеджмент в галузі морського та річкового транспорту">Менеджмент в галузі морського та річкового транспорту</option>
                        <option value="Право">Право</option>
                    </select>';
            }
            elseif ($_COOKIE["Select"]=='Автоматизоване управління судновими енергетичними установками'){
                echo '
                    <select class="field" name="Select" size="6" multiple id="f-sel">
                        <option value="Навігація і управління морськими суднами">Навігація і управління морськими суднами</option>
                        <option value="Управління судновими технічними системами і комплексами">Управління судновими технічними системами і комплексами</option>
                        <option value="Експлуатація суднового електрообладнання і засобів автоматики">Експлуатація суднового електрообладнання і засобів автоматики</option>
                        <option selected value="Автоматизоване управління судновими енергетичними установками">Автоматизоване управління судновими енергетичними установками</option>
                        <option value="Менеджмент в галузі морського та річкового транспорту">Менеджмент в галузі морського та річкового транспорту</option>
                        <option value="Право">Право</option>
                    </select>';
            }
            elseif ($_COOKIE["Select"]=='Менеджмент в галузі морського та річкового транспорту'){
                echo '
                    <select class="field" name="Select" size="6" multiple id="f-sel">
                        <option value="Навігація і управління морськими суднами">Навігація і управління морськими суднами</option>
                        <option value="Управління судновими технічними системами і комплексами">Управління судновими технічними системами і комплексами</option>
                        <option value="Експлуатація суднового електрообладнання і засобів автоматики">Експлуатація суднового електрообладнання і засобів автоматики</option>
                        <option value="Автоматизоване управління судновими енергетичними установками">Автоматизоване управління судновими енергетичними установками</option>
                        <option selected value="Менеджмент в галузі морського та річкового транспорту">Менеджмент в галузі морського та річкового транспорту</option>
                        <option value="Право">Право</option>
                    </select>';
            }
            else {
                echo '
                    <select class="field" name="Select" size="6" multiple id="f-sel">
                        ...
                        <option value="Автоматизоване управління судновими енергетичними установками">Автоматизоване управління судновими енергетичними установками</option>
                        <option value="Менеджмент в галузі морського та річкового транспорту">Менеджмент в галузі морського та річкового транспорту</option>
                        <option selected value="Право">Право</option>
                    </select>';
            }
        ?>
    </div>
    ...
    <div>
        ...
        <textarea class="field" rows="26" cols="35" wrap="hard" name="Results" id="f-res"><?= $_COOKIE["Results"] ?></textarea>
    ...
    <div>
        ...
        <input class="field" type="text" name="Leclab" id="f-leclab" value="<?= $_COOKIE["Leclab"] ?>">
    </div>
    ...
    <div>
        ...
        <input class="field" type="text" name="Control" id="f-control" value="<?= $_COOKIE["Control"] ?>">
    </div>
    ...
    <div>
        ...
        <textarea class="field" rows="26" cols="35" name="Content" id="f-content"><?= $_COOKIE["Content"] ?></textarea>
    </div>
    ...
    <div>
        ...
        <textarea class="field" rows="8" cols="35" name="Devices" id="f-device"><?= $_COOKIE["Devices"] ?></textarea>
    </div>
...
<div class="container_eng">
    ...
    <div>
        ...
        <input class="field" type="text" name="Name_eng" id="f-name1" value="<?= $_COOKIE["Name_eng"] ?>">
    </div>
    ...
    <div>
        ...
        <input class="field" type="text" name="bakmag_eng" id="f-bakmag1" value="<?= $_COOKIE["bakmag_eng"] ?>">
    ...
    <div>
        ...
        <input class="field" type="text" name="Lang_eng" id="f-mova1" value="<?= $_COOKIE["Lang_eng"] ?>">
    </div>
    ...
    <div>
        ...
        <?php
        if($_COOKIE["Select_eng"]=='Navigation'){
            echo '
        ...
        elseif ($_COOKIE["Select_eng"]=='Marine power plant operation and maintenance'){
            echo '
                    <select class="field" name="Select_eng" size="6" multiple id="f-sel1">
                        <option value="Navigation">Navigation</option>
                        <option selected value="Marine power plant operation and maintenance">Marine power plant operation and maintenance</option>
                        <option value="Operation and maintenance of ship electrical equipment and means of automation">Operation and maintenance of ship electrical equipment and means of automation</option>
                        <option value="Automated Control of Ships Power Plants">Automated Control of Ships Power Plants</option>
                        <option value="Management of organisations and administration of Sea and River Transport">Management of organisations and administration of Sea and River Transport</option>
                        <option value="Law">Law</option>
        ...
        elseif ($_COOKIE["Select_eng"]=='Operation and maintenance of ship electrical equipment and means of automation'){
            echo '
                    <select class="field" name="Select_eng" size="6" multiple id="f-sel1">
                        <option value="Navigation">Navigation</option>
                        <option value="Marine power plant operation and maintenance">Marine power plant operation and maintenance</option>
                        <option selected value="Operation and maintenance of ship electrical equipment and means of automation">Operation and maintenance of ship electrical equipment and means of automation</option>
                        <option value="Automated Control of Ships Power Plants">Automated Control of Ships Power Plants</option>
                        <option value="Management of organisations and administration of Sea and River Transport">Management of organisations and administration of Sea and River Transport</option>
                        <option value="Law">Law</option>
                    </select>';
        }
        elseif ($_COOKIE["Select_eng"]=='Automated Control of Ships Power Plants'){
            echo '
                    <select class="field" name="Select_eng" size="6" multiple id="f-sel1">
                        <option value="Navigation">Navigation</option>
                        <option value="Marine power plant operation and maintenance">Marine power plant operation and maintenance</option>
                        <option value="Operation and maintenance of ship electrical equipment and means of automation">Operation and maintenance of ship electrical equipment and means of automation</option>
                        <option selected value="Automated Control of Ships Power Plants">Automated Control of Ships Power Plants</option>
                        <option value="Management of organisations and administration of Sea and River Transport">Management of organisations and administration of Sea and River Transport</option>
                        <option value="Law">Law</option>
                    </select>';
        }
        elseif ($_COOKIE["Select_eng"]=='Management of organisations and administration of Sea and River Transport'){
            echo '
                    <select class="field" name="Select_eng" size="6" multiple id="f-sel1">
                        <option value="Navigation">Navigation</option>
                        <option value="Marine power plant operation and maintenance">Marine power plant operation and maintenance</option>
                        <option value="Operation and maintenance of ship electrical equipment and means of automation">Operation and maintenance of ship electrical equipment and means of automation</option>
                        <option value="Automated Control of Ships Power Plants">Automated Control of Ships Power Plants</option>
                        <option selected value="Management of organisations and administration of Sea and River Transport">Management of organisations and administration of Sea and River Transport</option>
                        <option value="Law">Law</option>
                    </select>';
        }
        else {
    ...
    <div>
        ...
        <textarea class="field" rows="26" cols="35" wrap="hard" name="Results_eng" id="f-res1"><?= $_COOKIE["Results_eng"] ?></textarea>
    </div>
    ...
    <div>
        ...
        <input class="field" type="text" name="Leclab_eng" id="f-leclab1" value="<?= $_COOKIE["Leclab_eng"] ?>">
    </div>
    ...
    <div>
        ...
        <input class="field" type="text" name="Control_eng" id="f-control1" value="<?= $_COOKIE["Control_eng"] ?>">
    </div>
    ...
    <div>
        ...
        <textarea class="field" rows="26" cols="35" name="Content_eng" id="f-content1"><?= $_COOKIE["Content_eng"] ?></textarea>
    </div>
    ...
    <div>
        ...
        <textarea class="field" rows="8" cols="35" name="Devices_eng" id="f-device1"><?= $_COOKIE["Devices_eng"] ?></textarea>
    </div>
